...
Sources/
  GenshinKeyboard/             ← التطبيق المضيف (المحول + صفحة تعليمات)
    AppDelegate.swift
...
| الزر | الوظيفة |
|------|---------|
| وضع: عادي (رمادي) | لا تغيير — يُرسل النص كما هو |
| وضع: Genshin (أخضر) | تشكيل + عكس (نفس أداة PC: «سلام» ← «ﻡﻼﺳ») |
| وضع: عكس فقط (برتقالي) | عكس الترتيب بأحرف أساسية («سلام» ← «مالس») |
| ⌫ | مسح آخر حرف |
| C | مسح كل النص |
| مسافة | مسافة |
| إرسال | يضع النص في الحقل حسب الوضع الحالي |
| 🌐 | التبديل إلى كيبورد آخر |

الزر العلوي يمرّ عبر الأوضاع الثلاثة بالضغط المتكرر. جرّب الأخضر أولاً لأنه يطابق
أداة الـ PC المثبتة، وإن بدت الحروف مفكوكة جرّب البرتقالي.

## المحول (خطة بديلة لا تعتمد على الكيبورد)
إذا واجهت مشكلة في إقلاع امتداد الكيبورد (يرتدّ للكيبورد الأساسي — خلل نظامي
موثق في iOS 17+ يصيب الكيبوردات الخارجية)، افتح تطبيق GenshinKeyboard واذهب
لتبويب **المحول**:

1. اكتب جملتك في الحقل.
2. اختر الوضع (Genshin / عكس).
3. اضغط **تحويل ونسخ** — يدخل النص المحوّل للحافظة.
4. في شات قنشن: اضغط مطولاً على حقل الكتابة ← **لصق**.

هذا يعمل حتى لو تعطّل الكيبورد، لأنه يستخدم الكيبورد العادي فقط.
